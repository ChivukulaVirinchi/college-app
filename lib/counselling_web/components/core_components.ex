defmodule CounsellingWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CounsellingWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CounsellingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CounsellingWeb.Gettext, "errors", msg, opts)
    end
  end
